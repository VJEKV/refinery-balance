...
const methodConfig = [
  {
    ...
    color: '#f87171',
    desc: 'Разница между входом и выходом установки. Порог — граница «Внимание», ×2 — «Критично». Пример: порог 3% → Внимание при >3%, Критично при >6%.',
  },
  {
    key: 'recon_gap', label: 'Расхождение измерено/согласовано', unit: '%', min: 1, max: 20, step: 0.5,
    color: '#f59e0b',
    desc: 'Разница между показаниями приборов и согласованным балансом. Порог — граница «Внимание», ×2 — «Критично». Пример: порог 5% → Внимание при >5%, Критично при >10%.',
  },
  {
    key: 'spc_sigma', label: 'Нетипичные дни', unit: 'σ', min: 1, max: 5, step: 0.5,
    color: '#3b82f6',
    desc: 'Дни с резким отклонением загрузки от среднего. Порог — граница «Внимание» (в σ), ×2 — «Критично». Пример: порог 2σ → Внимание при >2σ, Критично при >4σ.',
  },
  {
    key: 'downtime_pct', label: 'Простой', unit: '%', min: 1, max: 50, step: 1,
    color: '#64748b',
    desc: 'Снижение загрузки от нормы (75-й перцентиль). Порог — граница «Внимание», ×2 — «Критично». Пример: порог 10% → Внимание при снижении >10%, Критично >20%.',
  },
  {
    key: 'cross_unit', label: 'Потери продукции между установками', unit: '%', min: 1, max: 20, step: 0.5,
    color: '#22d3ee',
    desc: 'Потери при передаче продукта между установками. Порог — граница «Внимание», ×2 — «Критично». Пример: порог 5% → Внимание при >5%, Критично при >10%.',
  },
]
