...
const formulas = [
  ...
  },
  {
    ...
    formula: 'Δ = согласовано − замер. Δ% = (согласовано − замер) / замер × 100%',
    explain: 'Показывает направление и величину корректировки. Минус — значение уменьшили при согласовании, плюс — увеличили. Например, прибор показал 100 т, в отчёт записали 90 т → Δ = −10 т (−10%). Чем больше абсолютное значение, тем сильнее «подвинули» прибор.',
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <p className="text-sm text-dark-muted">
        ТИТАН МБ анализирует материальный баланс и автоматически выявляет аномалии.
      ...
      <div className="bg-dark-card border border-dark-border rounded-xl p-5">
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="text-xs font-medium text-dark-muted mb-2">Расхождение по продуктам (Δ = согласовано − замер)</div>
            <div className="flex gap-0.5">
              {[
      ...
      <div className="bg-dark-card border border-dark-border rounded-xl p-5">
        ...
        <div className="space-y-4 text-sm text-dark-muted">
          ...
          <div>
            ...
            <p>В таблицах аномалий нажмите на строку с датой — раскроется подробная таблица по продуктам за этот день. Видно: какой продукт, сколько замерено, сколько согласовано, какая корректировка в тоннах и процентах (Δ = согласовано − замер: минус — уменьшили, плюс — увеличили).</p>
          </div>
